...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO orders (name, email, town, country, zip_code, phone_number,
    address, total_price, user_id) VALUES (:name,
    :email, :town, :country, :zip_code, :phone_number, :address, :total_price, :user_id)";
                    ...
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form  class="col-md-12" method="POST" action="checkout.php">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input name="zip_code" type="text" class="form-control" id="email" placeholder="Zip Code">
