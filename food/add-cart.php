...
?>
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown"><?=$one->name?></h1>
                    ...
                    <div class="col-md-6">
                        <div class="row g-3">
                            <div class="col-12 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.1s" src="<?=APPURL?>/img/<?=$one->image?>">
                            </div>

                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h1 class="mb-4"><?=$one->name?></h1>
                        <p class="mb-4"><?=$one->description?></p>
                        <div class="row g-4 mb-4">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                                    <h3>Price: $<?=$one->price?> </h3>
                                </div>
                            </div>

                        </div>
                        <form method="POST" action="add-cart.php?id=<?=$id;?>">
                            <input type="hidden" name="item_id" value="<?=$one->id;?>">
                            <input type="hidden" name="name" value="<?=$one->name;?>">
                            <input type="hidden" name="image" value="<?=$one->image;?>">
